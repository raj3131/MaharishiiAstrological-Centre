                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {testimonials.map((testimonial, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="relative bg-white p-8 rounded-t-3xl rounded-br-3xl border border-[var(--color-3)]/10 hover:border-[var(--color-3)]/30 transition-all duration-500 backdrop-blur-md group hover:shadow-xl"
                        >
                            <Quote className="absolute top-6 right-6 w-10 h-10 text-[var(--color-3)]/10 group-hover:text-[var(--color-3)]/20 transition-colors rotate-180" />
