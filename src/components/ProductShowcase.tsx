                ...
                >
                    {products.map((product) => (
                        <Link href={`/products/${product.id}`} key={product.id}>
                            <motion.div variants={itemVariants} className="group relative bg-white rounded-3xl overflow-hidden border border-[var(--color-3)]/10 hover:border-[var(--color-3)]/40 transition-all duration-500 hover:shadow-xl cursor-pointer">
                                ...
                                <div className="h-[200px] md:h-[280px] w-full relative overflow-hidden bg-[var(--color-1)]/10">
                                    ...
                                    <button className="absolute bottom-4 right-4 bg-white text-[var(--foreground)] p-3 rounded-full shadow-lg translate-y-20 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 hover:bg-[var(--color-3)] hover:text-white z-20 border border-[var(--color-3)]/10">
                                        <ShoppingBag className="w-5 h-5" />
                                    </button>

                                    {/* Badge */}
                                    <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md border border-[var(--color-3)]/10 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider text-[var(--color-3)] shadow-sm">
                                        {product.category}
                                    </div>
                                </div>
                                ...
                                <div className="p-4 md:p-6 relative bg-white">
                                    ...
                                    <div className="w-full h-[1px] bg-gradient-to-r from-[var(--color-3)]/10 to-transparent my-3 md:my-4" />
